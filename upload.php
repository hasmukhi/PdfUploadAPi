...
if($_SERVER['REQUEST_METHOD']=='POST'){
    ...
    if(isset($_POST['name']) and isset($_FILES['pdf']['name'])){
        ...
        try{
            ...
            $sql = "INSERT INTO `pdfdetails` (`url`, `name`) VALUES ('$file_url', '$name');";
...
function getFileName(){
    $con = mysqli_connect("localhost","root","","webservice") or die('Unable to Connect...');
    $sql = "SELECT max(id) as id FROM pdfdetails";
